...
import { columnColors, type milestoneColumn } from "./milestone-config";

interface AddBoardDialogProps {
  onAddBoard: (board: Omit<milestoneColumn, "id"> & { id?: string }) => void;
  existingIds: string[];
}
      ...
      <DialogContent>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Create a new column board for your milestone.</DialogDescription>
          </DialogHeader>
