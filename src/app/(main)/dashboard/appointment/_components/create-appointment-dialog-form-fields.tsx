      ...
      <div className="space-y-3">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={() => setUseAutoGeneratedLink?.(true)}
            ...
            >
              <div className="flex items-center gap-2">
                <Monitor
                  className={`h-4 w-4 ${useAutoGeneratedLink ? "text-blue-700" : "text-gray-500"}`}
                />
                <span
                  className={`text-sm font-medium ${useAutoGeneratedLink ? "text-blue-700" : "text-gray-700"}`}
                >
                  Auto-generate
                </span>
              </div>
              <p
                className={`mt-1 text-xs ${useAutoGeneratedLink ? "text-blue-600" : "text-gray-500"}`}
              >
                Google Meet link
              </p>
            </button>
            ...
            <button
              type="button"
              onClick={() => setUseAutoGeneratedLink?.(false)}
              className={`flex-1 rounded-lg border p-3 text-left transition-colors ${
                !useAutoGeneratedLink
                  ? "border-blue-500 bg-blue-50"
                  : "border-gray-200 hover:border-gray-300"
        ...
        {useAutoGeneratedLink && (
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
            <p className="text-sm text-blue-600">
              Google Meet link will be auto-generated when appointment is created
            </p>
          </div>
        )}
      </div>
