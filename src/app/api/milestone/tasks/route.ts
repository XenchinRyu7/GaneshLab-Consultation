/**
 * POST /api/milestone/tasks - Create a new task/card
 * PATCH /api/milestone/tasks/[id]/move - Move task to different board or position
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    const maxTask = await prisma.milestoneTask.findFirst({
      where: { boardId },
